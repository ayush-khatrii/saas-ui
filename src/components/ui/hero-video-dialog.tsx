      ...
      <AnimatePresence>
        {isVideoOpen && (
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 text-white text-xl bg-zinc-900/50 ring-1 backdrop-blur-md rounded-full p-2 dark:bg-zinc-100/50 dark:text-black">
